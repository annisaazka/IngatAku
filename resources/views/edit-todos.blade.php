...
<html lang="en" dir="ltr">
  ...
  <title>To Dos</title>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/css/edit-todos.css">
...
<body>
  <div id="popup">
    ...
    <form action="{{ isset($data) ? route('protodos.update', $data->id) : route('protodos.store') }}" method="post">
    @csrf
      ...
      <div class="button">
        ...
        <a href="{{ route('protodos.index') }}">Close</a>
      </div>
    </form>
    </div>
  </div>
