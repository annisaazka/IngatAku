...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="css/pro-upcomingtask.css">
    ...
    <nav>
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="sales-details">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="button">
                    <a href="{{ route('proupcoming.edit', $item->id) }}" method="post">Edit</a>
                    <a href="{{ route('proupcoming.destroy', $item->id) }}" method="post">delete</a>
                  </div>
                </td>
              </tr>
              @endforeach
          ...
          <div class="addbutton">
            <a href="{{ route('proupcoming.addnew') }}">Add New Task</button>
          </div>
        </div>
      </div>
    </div>
